...
public class MonitoriaR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.monitoriar);
        Monitoria.PopupUtils.showSimplePopup(this, "Ricordati", "Per accedere, devi essere sotto dominio Mediaset");
